...
public class ProfHandler implements CallbackQueryHandler{
    ...
    public BotApiMethod<?> handle(Message message) {
        ...
        userDataCache.setUsersCurrentBotState(userId, BotState.PROF);

        SendMessage replyMessage = replyMessageService.getReplyMessage(chatId, ReplyMessage.PROF.getName());
